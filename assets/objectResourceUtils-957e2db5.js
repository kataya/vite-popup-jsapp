...
precision highp sampler2D;`,Yt=4;function Qs(){const t=new kt,e=t.fragment;t.include(mi);const r=(Yt+1)/2,o=1/(2*r*r);return e.include(Or),e.uniforms.add(new Z("depthMap",i=>i.depthTexture),new mt("tex",i=>i.colorTexture),new Gs("blurSize",i=>i.blurSize),new ee("projScale",(i,a)=>{const n=Yi(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,i.projScale-(n-5e4)):i.projScale}),new Ce("nearFar",(i,a)=>a.camera.nearFar)),e.code.add(s`
  ...
  `),t}const Zs=Object.freeze(Object.defineProperty({__proto__:null,build:Qs},Symbol.toStringTag,{value:"Module"}));let Js=class gi extends yr{initializeProgram(e){return new Cr(e.rctx,gi.shader.get().build(),Gt)}initializePipeline(){return xr({colorWrite:Tr})}};Js.shader=new Wt(Zs,()=>xt(()=>import("./SSAOBlur.glsl-472f8fe7.js"),["assets/SSAOBlur.glsl-472f8fe7.js","assets/index-265d95a6.js","assets/index-68e4a9fa.css","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-0af6c2cb.js","assets/vec32-e7e0b010.js","assets/DefaultMaterial_COLOR_GAMMA-31b951a6.js","assets/quat-35c60454.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-c715a60a.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-a29e243d.js","assets/sphere-486ecf96.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-81740760.js","assets/Texture-3f02b4cb.js","assets/InterleavedLayout-d48ac9ec.js","assets/types-1305598a.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-1c486fa9.js","assets/VertexElementDescriptor-2925c6af.js","assets/VertexArrayObject-9851830e.js"]));function Ys(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>el(r))),t.fragment.uniforms.add(new Ce("zScale",(e,r)=>xi(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
...
return fallOffFunction(vv, vn, 0.1);
  ...
  `),t}function Ti(t){return Math.max(10,20*t.computeScreenPixelSizeAtDist(Math.abs(4*t.relativeElevation)))}const co=_o(),rl=Object.freeze(Object.defineProperty({__proto__:null,build:tl,getRadius:Ti},Symbol.toStringTag,{value:"Module"}));let ol=class _i extends yr{initializeProgram(e){return new Cr(e.rctx,_i.shader.get().build(),Gt)}initializePipeline(){return xr({colorWrite:Tr})}};ol.shader=new Wt(rl,()=>xt(()=>import("./SSAO.glsl-ab08a952.js"),["assets/SSAO.glsl-ab08a952.js","assets/index-265d95a6.js","assets/index-68e4a9fa.css","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-0af6c2cb.js","assets/vec32-e7e0b010.js","assets/DefaultMaterial_COLOR_GAMMA-31b951a6.js","assets/quat-35c60454.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-c715a60a.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-a29e243d.js","assets/sphere-486ecf96.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-81740760.js","assets/Texture-3f02b4cb.js","assets/InterleavedLayout-d48ac9ec.js","assets/types-1305598a.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-1c486fa9.js","assets/VertexElementDescriptor-2925c6af.js","assets/VertexArrayObject-9851830e.js"]));const il=2;function Er(t,e){const r=t.fragment;e.receiveAmbientOcclusion?(r.uniforms.add(new Z("ssaoTex",(o,i)=>i.ssaoHelper.colorTexture)),r.constants.add("blurSizePixelsInverse","float",1/il),r.code.add(s`float evaluateAmbientOcclusionInverse() {
