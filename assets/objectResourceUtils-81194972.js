...
precision highp sampler2D;`,Yt=4;function Qs(){const t=new kt,e=t.fragment;t.include(mi);const r=(Yt+1)/2,o=1/(2*r*r);return e.include(Or),e.uniforms.add(new Z("depthMap",i=>i.depthTexture),new mt("tex",i=>i.colorTexture),new Gs("blurSize",i=>i.blurSize),new ee("projScale",(i,a)=>{const n=Yi(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,i.projScale-(n-5e4)):i.projScale}),new Ce("nearFar",(i,a)=>a.camera.nearFar)),e.code.add(s`
  ...
  `),t}const Zs=Object.freeze(Object.defineProperty({__proto__:null,build:Qs},Symbol.toStringTag,{value:"Module"}));let Js=class gi extends yr{initializeProgram(e){return new Cr(e.rctx,gi.shader.get().build(),Gt)}initializePipeline(){return xr({colorWrite:Tr})}};Js.shader=new Wt(Zs,()=>xt(()=>import("./SSAOBlur.glsl-3ff8b0b6.js"),["./SSAOBlur.glsl-3ff8b0b6.js","./index-4b712bf9.js","./index-68e4a9fa.css","./OrderIndependentTransparency-309a1bc3.js","./enums-b14466b3.js","./basicInterfaces-4ab7cc6a.js","./VertexAttribute-9f2e53ec.js","./mat3f64-221ce671.js","./mat4f64-1413b4a7.js","./BufferView-37980e06.js","./vec32-6afcaf83.js","./DefaultMaterial_COLOR_GAMMA-74a97526.js","./quat-fad84a56.js","./quatf64-3363c48e.js","./resourceUtils-1d112ccb.js","./Indices-92ebe572.js","./byteSizeEstimations-7cf1c05d.js","./NestedMap-1b5db22e.js","./requestImageUtils-7d0ab836.js","./sphere-ae209b09.js","./ByteSizeUnit-d4757d40.js","./lineSegment-3b1f40ae.js","./Texture-54f5847e.js","./InterleavedLayout-33f9827b.js","./types-1305598a.js","./vec3f32-ad1dc57f.js","./doublePrecisionUtils-e3c3d0d8.js","./symbolColorUtils-6ec1a778.js","./VertexElementDescriptor-2925c6af.js","./VertexArrayObject-608f719a.js"],import.meta.url));function Ys(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>el(r))),t.fragment.uniforms.add(new Ce("zScale",(e,r)=>xi(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
