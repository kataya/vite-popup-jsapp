...
precision highp sampler2D;`,Yt=4;function Qs(){const t=new kt,e=t.fragment;t.include(mi);const r=(Yt+1)/2,o=1/(2*r*r);return e.include(Or),e.uniforms.add(new Z("depthMap",i=>i.depthTexture),new mt("tex",i=>i.colorTexture),new Gs("blurSize",i=>i.blurSize),new ee("projScale",(i,a)=>{const n=Yi(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,i.projScale-(n-5e4)):i.projScale}),new Ce("nearFar",(i,a)=>a.camera.nearFar)),e.code.add(s`
  ...
  `),t}const Zs=Object.freeze(Object.defineProperty({__proto__:null,build:Qs},Symbol.toStringTag,{value:"Module"}));let Js=class gi extends yr{initializeProgram(e){return new Cr(e.rctx,gi.shader.get().build(),Gt)}initializePipeline(){return xr({colorWrite:Tr})}};Js.shader=new Wt(Zs,()=>xt(()=>import("./SSAOBlur.glsl-9f5e6903.js"),["./SSAOBlur.glsl-9f5e6903.js","./index-39c80a15.js","./index-68e4a9fa.css","./OrderIndependentTransparency-309a1bc3.js","./enums-b14466b3.js","./basicInterfaces-4ab7cc6a.js","./VertexAttribute-9f2e53ec.js","./mat3f64-221ce671.js","./mat4f64-1413b4a7.js","./BufferView-5dd4b7e4.js","./vec32-0d741145.js","./DefaultMaterial_COLOR_GAMMA-b0717f32.js","./quat-22020a23.js","./quatf64-3363c48e.js","./resourceUtils-1d112ccb.js","./Indices-987aafde.js","./byteSizeEstimations-7cf1c05d.js","./NestedMap-1b5db22e.js","./requestImageUtils-10a49c60.js","./sphere-9463b744.js","./ByteSizeUnit-d4757d40.js","./lineSegment-754ce5d4.js","./Texture-f4eddc92.js","./InterleavedLayout-230e359b.js","./types-1305598a.js","./vec3f32-ad1dc57f.js","./doublePrecisionUtils-e3c3d0d8.js","./symbolColorUtils-0fe3cccc.js","./VertexElementDescriptor-2925c6af.js","./VertexArrayObject-22fa0a19.js"],import.meta.url));function Ys(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>el(r))),t.fragment.uniforms.add(new Ce("zScale",(e,r)=>xi(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
