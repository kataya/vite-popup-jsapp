...
precision highp sampler2D;`,Yt=4;function Qs(){const t=new kt,e=t.fragment;t.include(mi);const r=(Yt+1)/2,o=1/(2*r*r);return e.include(Or),e.uniforms.add(new Z("depthMap",i=>i.depthTexture),new mt("tex",i=>i.colorTexture),new Gs("blurSize",i=>i.blurSize),new ee("projScale",(i,a)=>{const n=Yi(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,i.projScale-(n-5e4)):i.projScale}),new Ce("nearFar",(i,a)=>a.camera.nearFar)),e.code.add(s`
  ...
  `),t}const Zs=Object.freeze(Object.defineProperty({__proto__:null,build:Qs},Symbol.toStringTag,{value:"Module"}));let Js=class gi extends yr{initializeProgram(e){return new Cr(e.rctx,gi.shader.get().build(),Gt)}initializePipeline(){return xr({colorWrite:Tr})}};Js.shader=new Wt(Zs,()=>xt(()=>import("./SSAOBlur.glsl-af5f806a.js"),["./SSAOBlur.glsl-af5f806a.js","./index-b5294fcf.js","./index-68e4a9fa.css","./OrderIndependentTransparency-309a1bc3.js","./enums-b14466b3.js","./basicInterfaces-4ab7cc6a.js","./VertexAttribute-9f2e53ec.js","./mat3f64-221ce671.js","./mat4f64-1413b4a7.js","./BufferView-8a91b49a.js","./vec32-a9d340ac.js","./DefaultMaterial_COLOR_GAMMA-d9c4658a.js","./quat-fef70004.js","./quatf64-3363c48e.js","./resourceUtils-1d112ccb.js","./Indices-641a847e.js","./byteSizeEstimations-7cf1c05d.js","./NestedMap-1b5db22e.js","./requestImageUtils-315c7b79.js","./sphere-d3b488ae.js","./ByteSizeUnit-d4757d40.js","./lineSegment-82c79819.js","./Texture-7c6b4bbf.js","./InterleavedLayout-b8785f8b.js","./types-1305598a.js","./vec3f32-ad1dc57f.js","./doublePrecisionUtils-e3c3d0d8.js","./symbolColorUtils-354094e0.js","./VertexElementDescriptor-2925c6af.js","./VertexArrayObject-f85bb9b6.js"],import.meta.url));function Ys(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>el(r))),t.fragment.uniforms.add(new Ce("zScale",(e,r)=>xi(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
